...
export default function MiddleLayout() {
    ...
    return (
        ...
        <div style={{maxWidth:"100%",width:"50%",marginTop:100}} className='container'> 
            ...
            <Paper variant='outlined'>
                    <Box p={1} className={classes.boxBorder} style={{ textAlign: "center" }}>
                        <Link className='reservationLink' to='/middle/resroom' style={{ color: "black", textDecoration: "none" }}>Reserve Room</Link>
                </Box>
            </Paper>
            <br></br><br></br>
            <Paper variant='outlined'>
                    <Box p={1} className={classes.boxBorder} style={{ textAlign: "center" }}>
                        <Link className='reservationLink' to='/middle/bookroom' style={{ color: "black", textDecoration: "none" }}>Book Room</Link>
                </Box>
            </Paper>
